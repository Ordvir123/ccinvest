...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;600;700&family=Inter:wght@400;500;600&family=Frank+Ruhl+Libre:wght@500;700&family=Assistant:wght@400;500;600&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
